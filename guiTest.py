...
class GraphFrame(wx.Frame):
    ...
    def __init__(self):
        ...
        self.x = self.datagen.x
        self.y = self.datagen.y
        self.paused = True
    ...
    def create_main_panel(self):
        ...
        self.xmin_control = BoundControlBox(self.panel, -1, "X min", -200)
        self.xmax_control = BoundControlBox(self.panel, -1, "X max", 0)
        self.ymin_control = BoundControlBox(self.panel, -1, "Y min", 0)
        self.ymax_control = BoundControlBox(self.panel, -1, "Y max", 400)
    ...
    def init_plot(self):
        ...
        self.axes.set_title('XY-Plot', size=12)
...
##            )[0]
    ...
    def draw_plot(self):
        ...
        if self.xmax_control.is_auto():
            xmax = max(self.x) #len(self.data) if len(self.data) > 50 else 50
        else:
        ...
        if self.ymin_control.is_auto():
            ymin = 0 #round(min(self.data), 0) - 1
        else:
            ymin = int(self.ymin_control.manual_value())

        if self.ymax_control.is_auto():
            ymax = max(self.y) #round(max(self.data), 0) + 1
        else:
